    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VerificationRequests", x => x.VerificationId);
                    table.ForeignKey(
                        name: "FK_VerificationRequests_Admin_ApprovedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nid_verification = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Properties_VerificationRequests_nid_verification",
                        column: x => x.nid_verification,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VerificationRequests_ApprovedBy",
                table: "VerificationRequests",
                column: "ApprovedBy");

            migrationBuilder.CreateIndex(
                name: "IX_VerificationRequests_NidNumber",
                table: "VerificationRequests",
                column: "NidNumber",
                unique: true);
